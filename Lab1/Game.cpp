...
void Game::InitializeSystems()
{
	...
	_objHandler.CreateObject(_objHandler.textures[0], _objHandler.shaders[5], glm::vec3(5.0, 0.5, 0.0), glm::vec3(0.6, 0.6, 0.6), "..\\res\\objects\\monkey3.obj", 0);
	_objHandler.CreateObject(_objHandler.textures[2], _objHandler.shaders[5], glm::vec3(-5.0, 0.5, 0.0), glm::vec3(0.6, 0.6, 0.6), "..\\res\\objects\\backpack.obj", 2); // backpack
	_objHandler.CreateObject(_objHandler.textures[1], _objHandler.shaders[5], glm::vec3(5.0, 0.5, 0.0), glm::vec3(0.6, 0.6, 0.6), "..\\res\\objects\\cube.obj", 0);
	...
	_objHandler.CreateObject(_objHandler.textures[1], _objHandler.shaders[4], glm::vec3(-5.0, -5.0, -5.0), glm::vec3(4, 0.6, 4), "..\\res\\objects\\plane.obj", 4);

	_FBO.Generate(_gameDisplay.GetWidth(), _gameDisplay.GetHeight());
}
...
void Game::DrawGame()
{
	...
	_skyBox.DraweMapCube(_mainViewport, time);
